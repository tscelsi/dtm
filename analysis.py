...
if __name__ == "__main__":
    ...
    # res = tdma.create_plottable_topic_proportion_ot_df(include_names=False)
    # res1 = tdma1.create_plottable_topic_proportion_ot_df(include_names=False)
    # breakpoint()
    tdma.plot_topics_ot(os.path.join(os.environ['DTM_ROOT'], "dtm", "dataset_2a_last_20_years", "analysis_all_eurovoc_topics"), include_names=False, bucketed=False)
